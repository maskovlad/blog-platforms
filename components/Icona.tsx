export { MdOutlineLogout as LogOut } from "@react-icons/all-files/md/MdOutlineLogout";
...
export { TbLayoutDashboard as LayoutDashboard } from "@react-icons/all-files/tb/TbLayoutDashboard";
export { FiMenu as Menu } from "@react-icons/all-files/fi/FiMenu";
export { HiOutlineNewspaper as Newspaper } from "@react-icons/all-files/hi/HiOutlineNewspaper";
